...
const TopBanner = () => {
  return (
    <div className={`${styles.topBanner} d-flex flex-column flex-lg-row`} data-aos="slide-down">
        ...
        <Image src={images.OurStoryShape} alt="top banner shape" data-aos="slide-up" data-aos-anchor={styles.topBannerContent} />
    </div>
  )
}
